...
const RegisterPage = () => {
    ...
    const submitHandler = (e) => {
        ...
        if(password !== re_password) {
            ...
            const userData = {username, first_name, last_name, email, password, re_password}
                ...
                <Col className="justify-content-center">
                    <Form onSubmit={submitHandler}>
                        ...
                        <Form.Group controlId="re-password">
                            ...
                            <Form.Control type="password" placeholder="Re-enter Password" value={re_password} onChange={(e)=>setRePassword(e.target.value)}/>
                        </Form.Group>
