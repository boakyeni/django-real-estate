...
class Property(TimeStampedUUIDModel):
    ...
    desciption = models.TextField(verbose_name=_("Description"), default="Default description",)
    ...
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Blackhot Road")
    ...
    cover_photo=models.ImageField(
        ...
        default="/house_sample.jpg", null=True, blank=True
    )
